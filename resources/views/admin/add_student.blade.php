            ...
            <div class="card mb-4 mx-4">
              <div class="card-body p-4">
                ...
                <div class="input-group mb-3"><span class="input-group-text">
                  ...
                  <input class="form-control" name="student_maso" value="{{old('student_maso')}}" type="text" placeholder="Mã Số">
                </div>
                <div class="input-group mb-3"><span class="input-group-text">
                    </span>
                  <input class="form-control" name="student_name" value="{{old('student_name')}}" type="text" placeholder="Họ và tên">
                </div>
